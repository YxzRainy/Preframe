...
} from '/var/task/web/.netlify/dist/run/handlers/request-context.cjs'
import { getTracer, withActiveSpan } from '/var/task/web/.netlify/dist/run/handlers/tracer.cjs'

process.chdir('/var/task/web')
...
export default async function (req, context) {
  ...
  const handlerResponse = await runWithRequestContext(requestContext, () => {
    return withActiveSpan(tracer, 'Next.js Server Handler', async (span) => {
      ...
      if (!cachedHandler) {
        const { default: handler } = await import('/var/task/web/.netlify/dist/run/handlers/server.js')
